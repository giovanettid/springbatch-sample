...
@SystemProperty(name = "job.name", value = JobAlimentationConfiguration.JOB_NAME)
public class BatchApplicationAlimentationIT {
    ...
    public void run() throws IOException {
        BatchApplication.main(
                new String[]{JobAlimentationConfiguration.INPUT_FILE_PARAMETER + "=" + temporaryFolder.createFile("newFile")
                        .getPath()});
    }
